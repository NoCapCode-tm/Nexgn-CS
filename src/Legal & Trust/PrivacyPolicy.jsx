     ...
     <h1 className="privacy-hero-title">
      ...
      <div className="nexgn-data-list">
        <div className="nexgn-data-item">
          ...
          <p className="nexgn-data-text">
            <strong>Information You Provide Directly:</strong> When you join our
            wait list, register for an account, or contact support, we collect
            your email address, name and communication history.
          </p>
        </div>
        <div className="nexgn-data-item">
          <span className="nexgn-data-dot" />
          <p className="nexgn-data-text">
            ...
            paperless workflows, we process the documents you upload, the names
            and email addresses of designated signers, and the digital
        ...
        <div className="nexgn-data-item">
          ...
          <p className="nexgn-data-text">
            ...
            signature, we automatically collect telemetry data. This includes IP
            addresses, browser types, request timestamps, routing headers, and
            the specific authentication steps taken during the signing process
        ...
        <div className="nexgn-sharing-item">
          ...
          <div className="nexgn-sharing-text">
            ...
            <p className="nexgn-sharing-desc">
              When you execute a document workflow, necessary information (such
              as your name, email, signature, and IP-based audit trail) is
              shared with the other authorized participants (signers, viewers)
        ...
        <div className="nexgn-sharing-item">
          ...
          <div className="nexgn-sharing-text">
            ...
            <p className="nexgn-sharing-desc">
              ...
              regulatory mandate, we will disclose necessary data. We commit to
              notifying you of any such request unless legally prohibited from
              doing so.
            </p>
          </div>
        </div>
      ...
      <div className="nexgn-right-card nexgn-right-card--erasure">
        ...
        <p className="nexgn-right-card-desc">
          Request the deletion of your personal data (subject to legal retention
      ...
      <div className="nexgn-retention-body">
        <p className="nexgn-retention-text">
          ...
          using modern cryptographic standards. We retain personal and document
          data only for as long as your account is active or as needed to
          fulfill our legal obligations, resolve disputes, and enforce our
          agreements. Completed documents and cryptographic audit trails are
          retained based on your account settings to ensure long-term legal
          validity. Conversely, transient network logs used solely for security
          mitigation are purged on a rolling 30-day basis.
        </p>
      </div>
      ...
      <div className="nexgn-usage-list">
        ...
        <div className="nexgn-data-item">
          ...
          <p className="nexgn-data-text">
            ...
            audit trails, and ensure all digital signatures are legally binding.
          </p>
        </div>
        <div className="nexgn-data-item">
          <span className="nexgn-data-dot" />
          <p className="nexgn-data-text">
            To route documents securely between you and your designated signers
            or authorized viewers.
          </p>
        </div>
        <div className="nexgn-data-item">
          <span className="nexgn-data-dot" />
      ...
      <p className="nexgn-body-text">
        ...
        safeguard your information when you visit nexgn.cloud, use our services,
        or interact with our platform. We design our systems to comply with
        global privacy frameworks, including GDPR and CCPA, and we follow strict

        ...
        {features.map(f => (
          <div key={f.title} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 1 }}>
            ...
            <div style={{
              ...
              boxShadow: "0 4px 20px rgba(0,0,0,0.10)", display: "flex",
...
function DataSection() {
  const stats = [
    {
      icon: <svg width="47" height="47" viewBox="0 0 47 47" fill="none"><path d="M23.5 47C20.2492 47 17.1942 46.3839 14.335 45.1517C11.4758 43.9195 8.98875 42.2472 6.87375 40.1348C4.75875 38.0225 3.08437 35.5385 1.85063 32.6829C0.616875 29.8273 0 26.7761 0 23.5293C0 20.5955 0.567917 17.7204 1.70375 14.9039C2.83958 12.0874 4.42583 9.57407 6.4625 7.36392C8.49917 5.15377 10.9471 3.37391 13.8062 2.02434C16.6654 0.674782 19.7987 0 23.2062 0C24.0287 0 24.8708 0.0391178 25.7325 0.117353C26.5942 0.195589 27.4754 0.332501 28.3762 0.52809C28.0237 2.28839 28.1413 3.9509 28.7288 5.51561C29.3162 7.08032 30.1975 8.38098 31.3725 9.4176C32.5475 10.4542 33.9477 11.1681 35.5731 11.5593C37.1985 11.9505 38.8729 11.8527 40.5962 11.2659C39.5779 13.5739 39.7248 15.784 41.0369 17.8964C42.349 20.0087 44.2975 21.104 46.8825 21.1823C46.9217 21.6126 46.951 22.0135 46.9706 22.3851C46.9902 22.7568 47 23.1577 47 23.588C47 26.7957 46.3831 29.8175 45.1494 32.6536C43.9156 35.4896 42.2412 37.9736 40.1263 40.1055C38.0112 42.2374 35.5242 43.9195 32.665 45.1517C29.8058 46.3839 26.7508 47 23.5 47ZM19.975 18.8352C20.9542 18.8352 21.7865 18.4929 22.4719 17.8084C23.1573 17.1238 23.5 16.2926 23.5 15.3146C23.5 14.3367 23.1573 13.5054 22.4719 12.8208C21.7865 12.1363 20.9542 11.794 19.975 11.794C18.9958 11.794 18.1635 12.1363 17.4781 12.8208C16.7927 13.5054 16.45 14.3367 16.45 15.3146C16.45 16.2926 16.7927 17.1238 17.4781 17.8084C18.1635 18.4929 18.9958 18.8352 19.975 18.8352ZM15.275 30.5705C16.2542 30.5705 17.0865 30.2283 17.7719 29.5437C18.4573 28.8591 18.8 28.0279 18.8 27.0499C18.8 26.072 18.4573 25.2407 17.7719 24.5562C17.0865 23.8716 16.2542 23.5293 15.275 23.5293C14.2958 23.5293 13.4635 23.8716 12.7781 24.5562C12.0927 25.2407 11.75 26.072 11.75 27.0499C11.75 28.0279 12.0927 28.8591 12.7781 29.5437C13.4635 30.2283 14.2958 30.5705 15.275 30.5705ZM30.55 32.9176C31.2158 32.9176 31.774 32.6927 32.2244 32.2428C32.6748 31.793 32.9 31.2355 32.9 30.5705C32.9 29.9055 32.6748 29.3481 32.2244 28.8983C31.774 28.4484 31.2158 28.2235 30.55 28.2235C29.8842 28.2235 29.326 28.4484 28.8756 28.8983C28.4252 29.3481 28.2 29.9055 28.2 30.5705C28.2 31.2355 28.4252 31.793 28.8756 32.2428C29.326 32.6927 29.8842 32.9176 30.55 32.9176ZM23.5 42.3059C28.2783 42.3059 32.5181 40.6629 36.2194 37.377C39.9206 34.0911 41.9475 29.9055 42.3 24.8202C40.3417 23.9596 38.8044 22.7861 37.6881 21.2996C36.5719 19.8132 35.8179 18.1506 35.4262 16.3121C32.4104 15.8818 29.8254 14.5909 27.6712 12.4395C25.5171 10.288 24.1854 7.7062 23.6762 4.69413C20.5429 4.6159 17.7915 5.1831 15.4219 6.39576C13.0523 7.60841 11.0744 9.16334 9.48812 11.0605C7.90187 12.9578 6.70729 15.0212 5.90438 17.2509C5.10146 19.4806 4.7 21.5735 4.7 23.5293C4.7 28.732 6.53104 33.1621 10.1931 36.8196C13.8552 40.4771 18.2908 42.3059 23.5 42.3059Z" fill="#1C1B1F"/></svg>,
      title: "Cookies", label: "idk what to write"
    },
    {
      icon: <svg width="52" height="47" viewBox="0 0 52 47" fill="none"><path d="M6.76591 20.2981C6.1947 19.7302 5.90909 19.035 5.90909 18.2125C5.90909 17.39 6.1947 16.6948 6.76591 16.1269C7.33712 15.559 8.03636 15.275 8.86364 15.275C9.69091 15.275 10.3902 15.559 10.9614 16.1269C11.5326 16.6948 11.8182 17.39 11.8182 18.2125C11.8182 19.035 11.5326 19.7302 10.9614 20.2981C10.3902 20.866 9.69091 21.15 8.86364 21.15C8.03636 21.15 7.33712 20.866 6.76591 20.2981ZM41.0386 20.2981C40.4674 19.7302 40.1818 19.035 40.1818 18.2125C40.1818 17.39 40.4674 16.6948 41.0386 16.1269C41.6098 15.559 42.3091 15.275 43.1364 15.275C43.9636 15.275 44.6629 15.559 45.2341 16.1269C45.8053 16.6948 46.0909 17.39 46.0909 18.2125C46.0909 19.035 45.8053 19.7302 45.2341 20.2981C44.6629 20.866 43.9636 21.15 43.1364 21.15C42.3091 21.15 41.6098 20.866 41.0386 20.2981ZM7.09091 47H2.36364V37.6H11.8182C9.21818 37.6 6.99242 36.6796 5.14091 34.8387C3.28939 32.9979 2.36364 30.785 2.36364 28.2H7.09091C7.09091 29.4925 7.55379 30.599 8.47955 31.5194C9.4053 32.4398 10.5182 32.9 11.8182 32.9V25.85H18.2L15.9545 16.7437C15.0485 13.1404 13.1083 10.2323 10.1341 8.01937C7.15985 5.80646 3.78182 4.7 0 4.7V0C4.84545 0 9.18864 1.42958 13.0295 4.28875C16.8705 7.14792 19.3621 10.9079 20.5045 15.5687L23.5773 27.6125C23.7742 28.3567 23.6364 29.0323 23.1636 29.6394C22.6909 30.2465 22.0606 30.55 21.2727 30.55H16.5455V37.6C16.5455 38.8925 16.0826 39.999 15.1568 40.9194C14.2311 41.8398 13.1182 42.3 11.8182 42.3H7.09091V47ZM49.6364 47H44.9091V42.3H40.1818C38.8818 42.3 37.7689 41.8398 36.8432 40.9194C35.9174 39.999 35.4545 38.8925 35.4545 37.6V30.55H30.7273C29.9394 30.55 29.3091 30.2367 28.8364 29.61C28.3636 28.9833 28.2455 28.2783 28.4818 27.495L31.4955 15.5687C32.7561 11.0646 35.2576 7.34375 39 4.40625C42.7424 1.46875 47.0758 0 52 0V4.7C48.2576 4.7 44.8992 5.81625 41.925 8.04875C38.9508 10.2812 37.0106 13.1796 36.1045 16.7437L33.8 25.85H40.1818V32.9C41.4818 32.9 42.5947 32.4398 43.5205 31.5194C44.4462 30.599 44.9091 29.4925 44.9091 28.2H49.6364C49.6364 30.785 48.7106 32.9979 46.8591 34.8387C45.0076 36.6796 42.7818 37.6 40.1818 37.6H49.6364V47Z" fill="#1C1B1F"/></svg>,
      title: "SOC 2", label: "Compliant"
    },
    {
      icon: <svg width="55" height="54" viewBox="0 0 55 54" fill="none"><ellipse cx="27.5" cy="27" rx="24" ry="23.5" stroke="black" strokeWidth="7" strokeDasharray="4 4"/></svg>,
      title: "GDPR", label: "Compliant"
    },
    {
      icon: <svg width="47" height="47" viewBox="0 0 47 47" fill="none"><path d="M30.9773 47C27.2742 47 24.0074 45.8962 21.1767 43.6886C18.346 41.4811 16.4678 38.6682 15.542 35.25C17.1443 35.3212 18.7288 35.161 20.2955 34.7693C21.8621 34.3777 23.3576 33.8258 24.7818 33.1136H33.5409C33.5765 32.722 33.6032 32.3392 33.621 31.9653C33.6388 31.5915 33.6477 31.2087 33.6477 30.817C33.6477 30.4966 33.6388 30.1672 33.621 29.829C33.6032 29.4907 33.5765 29.1614 33.5409 28.8409H30.3898C30.9595 28.2 31.4847 27.5235 31.9653 26.8114C32.446 26.0992 32.8822 25.3515 33.2739 24.5682H40.8046C40.0924 23.5 39.2379 22.5653 38.2409 21.7642C37.2439 20.9631 36.1224 20.3489 34.8761 19.9216C35.0542 19.2095 35.1699 18.4795 35.2233 17.7318C35.2767 16.9841 35.2856 16.2542 35.25 15.542C38.6682 16.4678 41.4811 18.346 43.6886 21.1767C45.8962 24.0074 47 27.2742 47 30.9773C47 35.428 45.4422 39.2112 42.3267 42.3267C39.2112 45.4422 35.428 47 30.9773 47ZM25.9034 41.5523C25.6542 40.8402 25.4316 40.1458 25.2358 39.4693C25.04 38.7928 24.8708 38.0985 24.7284 37.3864H21.15C21.7553 38.2765 22.4585 39.0777 23.2597 39.7898C24.0608 40.5019 24.942 41.0894 25.9034 41.5523ZM30.9773 42.3C31.4045 41.5167 31.7695 40.7155 32.0722 39.8966C32.3748 39.0777 32.633 38.2409 32.8466 37.3864H29.108C29.3216 38.2409 29.5886 39.0777 29.9091 39.8966C30.2295 40.7155 30.5856 41.5167 30.9773 42.3ZM36.0511 41.5523C37.0125 41.0894 37.8938 40.5019 38.6949 39.7898C39.496 39.0777 40.1992 38.2765 40.8046 37.3864H37.2261C37.0481 38.0985 36.8701 38.7928 36.6921 39.4693C36.514 40.1458 36.3004 40.8402 36.0511 41.5523ZM37.8136 33.1136H42.5136C42.5849 32.7576 42.6383 32.4104 42.6739 32.0722C42.7095 31.7339 42.7273 31.3689 42.7273 30.9773C42.7273 30.5856 42.7095 30.2206 42.6739 29.8824C42.6383 29.5441 42.5849 29.197 42.5136 28.8409H37.8136C37.8492 29.1614 37.8759 29.4907 37.8938 29.829C37.9116 30.1672 37.9205 30.4966 37.9205 30.817C37.9205 31.2087 37.9116 31.5915 37.8938 31.9653C37.8759 32.3392 37.8492 32.722 37.8136 33.1136ZM16.0227 32.0455C11.572 32.0455 7.78883 30.4877 4.6733 27.3722C1.55777 24.2566 0 20.4735 0 16.0227C0 11.572 1.55777 7.78883 4.6733 4.6733C7.78883 1.55777 11.572 0 16.0227 0C20.4735 0 24.2566 1.55777 27.3722 4.6733C30.4877 7.78883 32.0455 11.572 32.0455 16.0227C32.0455 20.4735 30.4877 24.2566 27.3722 27.3722C24.2566 30.4877 20.4735 32.0455 16.0227 32.0455ZM16.0227 27.7727C19.2629 27.7727 22.0312 26.6244 24.3278 24.3278C26.6244 22.0312 27.7727 19.2629 27.7727 16.0227C27.7727 12.7826 26.6244 10.0142 24.3278 7.71761C22.0312 5.42102 19.2629 4.27273 16.0227 4.27273C12.7826 4.27273 10.0142 5.42102 7.71761 7.71761C5.42102 10.0142 4.27273 12.7826 4.27273 16.0227C4.27273 19.2629 5.42102 22.0312 7.71761 24.3278C10.0142 26.6244 12.7826 27.7727 16.0227 27.7727ZM10.6818 14.9545C11.2871 14.9545 11.7945 14.7498 12.204 14.3403C12.6134 13.9309 12.8182 13.4235 12.8182 12.8182C12.8182 12.2129 12.6134 11.7055 12.204 11.296C11.7945 10.8866 11.2871 10.6818 10.6818 10.6818C10.0765 10.6818 9.56913 10.8866 9.15966 11.296C8.75019 11.7055 8.54545 12.2129 8.54545 12.8182C8.54545 13.4235 8.75019 13.9309 9.15966 14.3403C9.56913 14.7498 10.0765 14.9545 10.6818 14.9545ZM16.0227 24.3545C17.7318 24.3545 19.254 23.8739 20.5892 22.9125C21.9244 21.9511 22.8947 20.7227 23.5 19.2273H8.54545C9.15076 20.7227 10.121 21.9511 11.4563 22.9125C12.7915 23.8739 14.3136 24.3545 16.0227 24.3545ZM21.3636 14.9545C21.9689 14.9545 22.4763 14.7498 22.8858 14.3403C23.2953 13.9309 23.5 13.4235 23.5 12.8182C23.5 12.2129 23.2953 11.7055 22.8858 11.296C22.4763 10.8866 21.9689 10.6818 21.3636 10.6818C20.7583 10.6818 20.2509 10.8866 19.8415 11.296C19.432 11.7055 19.2273 12.2129 19.2273 12.8182C19.2273 13.4235 19.432 13.9309 19.8415 14.3403C20.2509 14.7498 20.7583 14.9545 21.3636 14.9545Z" fill="#1C1B1F"/></svg>,
